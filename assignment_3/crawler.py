...
def parse(html):
    try:
        ...
        return {
            'isTargetPage': (h1 := bs.find('h1', attrs={ 'class': 'cpp-h1' })) and h1.get_text() == 'Permanent Faculty',
...
def crawlerThread(frontier: Frontier):
...
if __name__ == "__main__":
    ...
    pages = db["pages"]
    pages.drop()
    crawlerThread(Frontier("https://www.cpp.edu/sci/computer-science/"))
